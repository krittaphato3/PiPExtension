...
const KEYS = { 
    ...
    LOCK_PAN: 'pipLockPan',
    INVERT_ZOOM: 'pipInvertZoom',
    RESET_DBL: 'pipDblClickReset',
...
const els = {
    ...
    inputs: {
        ...
        [KEYS.INVERT_ZOOM]: document.getElementById('pipInvertZoom'),
        [KEYS.RESET_DBL]: document.getElementById('pipDblClickReset'),
