...
// ============================================================================
// STATE - Track all popup PiP windows
// ============================================================================
const PiPFactory = {
  ...
  async create(options = {}) {
    ...
    // ── Step 0: Ensure cross-tab state is loaded (lazy init) ───────────────
   ...
   * @returns {boolean}
   */
  _shouldUsePopup({ videoElement, screenId, left, top, forcePopup, forceNative }) {
